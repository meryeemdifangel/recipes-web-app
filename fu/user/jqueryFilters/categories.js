...
var cat = $("#filterBtnTry").attr("data-attr");

  $.ajax({
        type: "POST",
        url: "../filterCategoryPage.php",
        data: {cat :cat,filterSaison:valueSeason ,cookingTimeFilter:valueCooking , preparationTimeFilter:valuePreparation , restTimeFilter:valueRest ,totalTimeFilter:valueTotal,  caloriesFilter:valueCalories , filterNotation:valueNotation,order:valueOrder},
